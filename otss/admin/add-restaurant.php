...
$images=md5($images).time().$extension;
 move_uploaded_file($_FILES["images"]["tmp_name"],"images/".$images);
  $sql="insert into tbltiffin(Title,Description,Cost,Image,Rname)values(:title,:desc,:cost,:images,:type)";
//   $sql="INSERT INTO tbluser(FullName) VALUES (:title)";
...
echo "<script>window.location.href ='add-restaurant.php'</script>";
  }
  else
    {
