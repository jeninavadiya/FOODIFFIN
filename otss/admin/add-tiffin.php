...
$images=md5($images).time().$extension;
 move_uploaded_file($_FILES["images"]["tmp_name"],"images/".$images);
  $sql="insert into tbltiffin(Title,Description,Cost,Image,rid,Rname)values(:title,:desc,:cost,:images,:arid,:type)";
     ...
     $query->bindParam(':arid',$arid,PDO::PARAM_STR);
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2">Restaurant: </label>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <select type="text" class="form-control" id="" name="type" value="" required='true'>
                                                                ...
                                                                <option value="Jay Punjabi Dhaba">Jay Punjabi Dhaba</option>
                                                                <option value="Atithi Restaurant">Atithi Restaurant</option>
                                                                <option value="Bombay Caterers">Bombay Caterers</option>
                                                                <option value="Sainath Restaurant">Sainath Restaurant</option>  
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2">Restaurant Id: </label>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <select type="text" class="form-control" id="" name="rid" value="" required='true'>
                                                                <option value="">Choose Restaurant Id</option>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-md-2">Contains: </label>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
