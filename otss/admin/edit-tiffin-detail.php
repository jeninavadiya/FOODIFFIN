...
if (strlen($_SESSION['otssaid']==0)) {
  ...
  $cost=$_POST['cost'];
 $eid=$_GET['editid'];
  $sql="update tbltiffin set Rname=:type,Title=:title,Description=:desc,Cost=:cost where ID=:eid";
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <select type="text" class="form-control" id="" name="type" value="" required='true'>
                                                                <option value="<?php  echo htmlentities($row->Rname);?>"><?php  echo htmlentities($row->Rname);?></option>
