  ...
  if(isset($_POST['submit']))
    {
        ...
        $sql= "UPDATE tblcancel SET CancellationDate='$tcost',Remark='$remark',Status='$status'  WHERE OrderNumber='$vid'";
        ...
        if (mysqli_query($conn, $sql)) {
          echo '<script>alert("Remark has been updated")</script>';
            echo "<script>window.location.href ='onedaycorder.php'</script>";
        } else {
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">View One Day Cancel Requests</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="dashboard.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">View One Day Cancel Requests</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Order Number Details:</h4>
...
<?php  if($status!=''){
$ret="select * from tblcancel  where OrderNumber=:vid";
...
<tr>
    <td><?php echo $cnt;?></td>
    <td><?php  echo $on=$row->OrderNumber;?></td> 
    <td><?php  echo $row->Remark;?></td>
    <td><?php  echo $status=$row->Status;?></td> 
    <td><?php  echo $upd=$row->UpdationDate;?></td> 
</tr>
<?php $cnt=$cnt+1;}} }?>
</table>
<?php 
      ...
      <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <table class="table table-bordered table-hover data-tables">                          
              ...
              <tr>
                <th>Refundable Ammount:</th>
                <td>
                <input name="cost" value="<?php echo ($tc/$ddf); ?>" class="form-control wd-450" required="true" readonly></td>
              </tr>                         
              <tr>
                <th>Status :</th>
                  <td>
