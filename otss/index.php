				...
				<div class="ordering-section-grids">
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s">
							<i class="one"></i><br>
							<i class="one-icon"></i>
							<p>Choose Your Tiffin Service</p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
...
{               ?>
						<div class="col-md-6" data-wow-delay="0.4s">
						    ...
						    <a href="rtiffins.php?rid=<?php echo $row->rid;?>"><img src="admin/images/<?php echo $row->Image; ?>" width="450" height="250" /> </a>
						    
							<label style="padding-top: 20px;padding-bottom: 20px"><?php  echo htmlentities($row->Name);?>: <?php  echo htmlentities($row->Address);?></label>
